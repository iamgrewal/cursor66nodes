...
echo -e "${GRAY}====${RESET}"
echo -e "${GRAY}Repository: https://github.com/iamgrewal/cursor-rules${RESET}"
echo -e "${GRAY}====${RESET}\n"

RULES_DIR="$TARGET_DIR/.cursor/rules"
RAW_URL="https://raw.githubusercontent.com/iamgrewal/cursor-rules/refs/heads/master/.cursor/rules"
